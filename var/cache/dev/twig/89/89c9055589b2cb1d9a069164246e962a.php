...
class __TwigTemplate_ed4eaaf5093a0e05ce1d5a653f7124cd extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "\" class=\"border-primary marge2\" width=\"550\" height=\"auto\">
<div class=\"card border-primary mb-3 test\"  style=\"max-width: 30rem;\">
...
{% block body %}
<img src=\"{{ asset('photo7.png') }}\" class=\"border-primary marge2\" width=\"550\" height=\"auto\">
<div class=\"card border-primary mb-3 test\"  style=\"max-width: 30rem;\">
    <div class=\"card-header\"><h1> Créer des outils et applications informatiques </h1>
        <br>
        <br>
    ...
    <img src=\"{{ asset('photo8.png') }}\" class=\"rounded-corners marge\" width=\"450\" height=\"auto\">
